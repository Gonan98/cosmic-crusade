...
namespace RTSEngine
{
    ...
    public class TaskUI : MonoBehaviour
    {
        ...
        public TaskUIAttributes attributes { set; get; }
        ...
        private void Update()
        {
            ...
            if (!float.IsNaN(nextBarLength) && !float.IsInfinity(nextBarLength))
        ...
        public void OnTaskClick()
        {
            ...
            {
                //Debug.Log("INGRESO AL IF OnTaskClick");
				...
				//Debug.Log("INGRESO AL ELSE OnTaskClick");
