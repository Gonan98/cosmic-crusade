	...
	public class UnitManager : MonoBehaviour {
        ...
        public void OnFactionSlotsInitialized ()
        {
            ...
            foreach (Unit u in freeUnits)
            {
                ...
                //CreateUnitLocal(unit, unit.gameObject.transform.position, unit.gameObject.transform.rotation, unit.gameObject.transform.position, 0, null, false, false);
                //var photonView = u.GetComponent<PhotonView>();
        ...
        public Unit CreateUnitLocal (Unit unitPrefab, Vector3 spawnPosition, Quaternion spawnRotation, Vector3 gotoPosition, int factionID, Building createdBy, bool free = false, bool updatePopulation = true)
        {
            ...
            //object[] data = new object[] { factionID, free, gotoPosition };
            Unit newUnit = PhotonNetwork.Instantiate(unitPrefab.name, spawnPosition, spawnRotation).GetComponent<Unit>();
