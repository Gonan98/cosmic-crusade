...
namespace RTSEngine
{
    ...
    public class TaskManager : MonoBehaviour
    {
        ...
        public ErrorMessage CanAddTask(FactionEntity factionEntity, FactionEntityTask task)
        {
            ...
            {
                if (((Building)factionEntity).IsBuilt == false && task.GetCode() != "destroy_building")
        ...
        public ErrorMessage CanAddTaskToLauncher(TaskLauncher taskLauncher, FactionEntityTask task)
        {
            ...
            return CanAddTask(taskLauncher.FactionEntity, task);
        }
