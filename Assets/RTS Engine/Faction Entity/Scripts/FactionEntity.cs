    ...
    public abstract class FactionEntity : Entity
    {
        ...
        public struct ColoredRenderer
        {
            ...
            public void UpdateColor (Color color)
            {
                ...
                if (emission) {
                    renderer.materials[materialID].SetColor("_EmissionColor", color);
                }
                if (isShader) {
                    renderer.materials[materialID].SetColor("MColor", color);
                    renderer.materials[materialID].SetColor("EColor", color);
                }
            }
        }
        [SerializeField]
