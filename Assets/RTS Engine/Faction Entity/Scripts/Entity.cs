...
namespace RTSEngine
{
    ...
    public abstract class Entity : MonoBehaviourPun
    {
        ...
        public void EnableSelectionPlane ()
        {
			...
			Color nextColor = new Color(0, 255, 0, 255);
			//Color nextColor = free ? gameMgr.SelectionMgr.GetFreeSelectionColor() : color; //get the color
            plane.GetComponent<Renderer>().material.color = new Color(nextColor.r, nextColor.g, nextColor.b, 1.0f); //update the plane's color
        }
