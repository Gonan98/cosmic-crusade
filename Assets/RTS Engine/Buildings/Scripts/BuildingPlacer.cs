...
namespace RTSEngine
{
    ...
    public class BuildingPlacer : MonoBehaviour
    {
        ...
        public void PlaceBuilding()
        {
            ...
            if (building.gridPositionList != null) {
                GridObjectItem gridObjectItem = new GridObjectItem(building.transform, null, building.GetWidth(), building.GetLength());
                foreach (Vector2Int gridPosition in building.gridPositionList) {
                    gameMgr.PlacementMgr.grid.GetGridObject(gridPosition.x, gridPosition.y).SetPlacedObject(gridObjectItem);
                }         
            }
        ...
        public bool IsBuildingOnMap()
        {
            ...
            {
                hits = Physics.RaycastAll(ray, gameMgr.PlacementMgr.GetGroundMaxDistance()); //apply the raycast and store the hits
        ...
        public bool AreTilesValid()
        {   
            return GameObject.FindGameObjectsWithTag("BusyStatusTile").Count() == 0;
        }
    }
}
