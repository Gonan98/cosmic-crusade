...
public class SelectionManagerEditor : Editor
{
    ...
    private void OnGeneralInspectorGUI ()
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.PropertyField(manager_SO.FindProperty("taskPanel"), new GUIContent("Task Panel"), true);
        EditorGUILayout.PropertyField(manager_SO.FindProperty("selectionPanel"), new GUIContent("Selection Panel"), true);
    }
