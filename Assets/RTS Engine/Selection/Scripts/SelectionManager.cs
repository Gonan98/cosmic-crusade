...
namespace RTSEngine
{
    public class SelectionManager : MonoBehaviourPunCallbacks
    {
        ...
        public void EnablePanels(bool value)
        {
            taskPanel.SetActive(value);
        ...
        {
            //Debug.Log("OnSelectedUnitsAction");
        ...
        {
			//Debug.Log("SelectFactionEntitiesInRange");
