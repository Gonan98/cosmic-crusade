...
namespace RTSEngine
{
    ...
    public class AttackManager : MonoBehaviour
    {
        ...
        {
			Debug.Log("IsAttackUnit");
            Debug.Log(unit.AttackComp && unit.AttackComp.IsActive);
