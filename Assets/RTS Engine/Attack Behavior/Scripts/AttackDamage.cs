...
namespace RTSEngine.Attack
{
    ...
    public class AttackDamage
    {
        ...
        public void SetUnitDamage(int newUnitDamage) {unitDamage = newUnitDamage;}
        ...
        public void SetBuildingDamage(int newBuildingDamage) {buildingDamage = newBuildingDamage;}
